...
public class FragmentThursday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View tableDay = inflater.inflate(R.layout.fragment_thursday, container, false);
        ...
        tvDate = (TextView) tableDay.findViewById(R.id.tvDate);
            tvDate.setText(MainActivity.weeksName[MainActivity.selectedWeek][3]);
            increate = true;

            String[] selectionArgs = new String[]{MainActivity.weeks[MainActivity.selectedWeek][3], MainActivity.savedId};
