...
public class FragmentTuesday extends Fragment {
    ...
    public static FragmentTuesday newInstance() {
        FragmentTuesday fragment = new FragmentTuesday();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View tableDay = inflater.inflate(R.layout.fragment_tuesday, container, false);
        ...
        tvDate = (TextView) tableDay.findViewById(R.id.tvDate);
            tvDate.setText(MainActivity.weeksName[MainActivity.selectedWeek][1]);
            increate = true;

            String[] selectionArgs = new String[]{MainActivity.weeks[MainActivity.selectedWeek][1], MainActivity.savedId};
