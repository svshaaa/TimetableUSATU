...
public class FragmentWednesday extends Fragment {
    ...
    public static FragmentWednesday newInstance() {
        FragmentWednesday fragment = new FragmentWednesday();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View tableDay = inflater.inflate(R.layout.fragment_wednesday, container, false);
        linearGeneral = (LinearLayout) tableDay.findViewById(R.id.lgWednesday);
        linearDate = (LinearLayout) tableDay.findViewById(R.id.linearDate);
        tvDate = (TextView) tableDay.findViewById(R.id.tvDate);
            tvDate.setText(MainActivity.weeksName[MainActivity.selectedWeek][2]);
            increate = true;


            String[] selectionArgs = new String[]{MainActivity.weeks[MainActivity.selectedWeek][2], MainActivity.savedId};
