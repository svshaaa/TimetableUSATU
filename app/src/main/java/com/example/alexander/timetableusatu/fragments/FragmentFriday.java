...
public class FragmentFriday extends Fragment {
    ...
    static LinearLayout linearGeneral;
    public static TextView tvDate;
    public static boolean increate = false;

    public static FragmentFriday newInstance() {
        FragmentFriday fragment = new FragmentFriday();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View tableDay = inflater.inflate(R.layout.fragment_friday, container, false);
        linearGeneral = (LinearLayout) tableDay.findViewById(R.id.linearGeneral);
        tvDate = (TextView) tableDay.findViewById(R.id.tvDate);
            tvDate.setText(MainActivity.weeksName[MainActivity.selectedWeek][4]);
            increate = true;
            String[] selectionArgs = new String[]{MainActivity.weeks[MainActivity.selectedWeek][4], MainActivity.savedId};
